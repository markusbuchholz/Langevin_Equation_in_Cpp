...
//-----------------------------------------------------------
// vx
float function1(float x, float y, float vx, float vy)
{
...
//-----------------------------------------------------------
// vy
float function2(float x, float y, float vx, float vy)
{
...
//-----------------------------------------------------------
// vx_dot
float function3(float x, float y, float vx, float vy)
{

    float ret = -(G / m) * vx + R * noise();
...
//-----------------------------------------------------------
// vy_dot
float function4(float x, float y, float vx, float vy)
{

    float ret = -(G / m) * vy + R * noise();
    return ret;
}

//-----------------------------------------------------------

std::tuple<std::vector<float>, std::vector<float>, std::vector<float>, std::vector<float>, std::vector<float>> methodRuneKuttaLangevin()
{
...
int main()
{
    ...
    std::tuple<std::vector<float>, std::vector<float>, std::vector<float>, std::vector<float>, std::vector<float>> particle = methodRuneKuttaLangevin();

    std::tuple<std::vector<float>, std::vector<float>> XY = std::make_tuple(std::get<0>(particle), std::get<1>(particle));
